    ...
    public class OracleTestSuite : TestSuite
    {
        ...
        static OracleTestSuite()
        {
            using (var connection = new OracleConnection(ConnectionString))
            {
                ...
                DropTable("Stuff");
                connection.Execute("CREATE TABLE Stuff (TheId number(10,0) generated by default on null as identity not null, Name varchar2(100) not null, Created DATE null)");
                connection.Execute("ALTER TABLE Stuff ADD CONSTRAINT Stuff_pk PRIMARY KEY (TheId)");

                DropTable("People");
                connection.Execute("CREATE TABLE People (Id number(10,0) generated by default on null as identity not null, Name varchar2(100) not null)");
                connection.Execute("ALTER TABLE People ADD CONSTRAINT People_pk PRIMARY KEY (Id)");

                DropTable("Users");
                connection.Execute("CREATE TABLE Users (Id number(10,0) generated by default on null as identity not null, Name varchar2(100) not null, Age number(10,0) not null)");
                connection.Execute("ALTER TABLE Users ADD CONSTRAINT Users_pk PRIMARY KEY (Id)");

                DropTable("Automobiles");
                connection.Execute("CREATE TABLE Automobiles (Id number(10,0) generated by default on null as identity not null, Name varchar2(100) not null)");
                connection.Execute("ALTER TABLE Automobiles ADD CONSTRAINT Automobiles_pk PRIMARY KEY (Id)");

                DropTable("Results");
                connection.Execute("CREATE TABLE Results (Id number(10,0) generated by default on null as identity not null, Name varchar2(100) not null, \"ORDER\" number(10,0) not null)");
