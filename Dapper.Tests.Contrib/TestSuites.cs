...
namespace Dapper.Tests.Contrib
{
    ...
    public class OracleTestSuite : TestSuite
    {
        ...
        // Fix SQL hardcoded to use Oracle bind variable syntax.

        protected override string BuilderTemplateWithoutComposition_Sql => "SELECT COUNT(*) FROM Users WHERE Age = :age";
    }
#endif
}
